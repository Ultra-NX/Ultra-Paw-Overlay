...
static const std::string monitorSettingsConfigIniPath = "sdmc:/config/status-monitor/"+configFileName;
...
void copyTeslaKeyComboToUltrahand() {
    std::string keyCombo = "L+R+DUP";
    std::map<std::string, std::map<std::string, std::string>> parsedData;
    std::string legacyComment = "; Auto-generated by Ultra Paw for legacy compatibility.\n; See '/config/ultrapaw/config.ini' for Ultra Paw settings.\n\n";
    ...
    if (initializeTesla) {
        ...
        setIniFileValue(monitorSettingsConfigIniPath, "status-monitor", "key_combo", keyCombo, legacyComment);
    }
