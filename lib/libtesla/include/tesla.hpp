...
namespace tsl {
    ...
    namespace elm {
        ...
        public:
            ...
            bool invertBGClickColor = (parseValueFromIniSection("/config/ultrapaw/theme.ini", "theme", "invert_bg_click_color") == "true");
            Color selectionBGColor = RGB888(parseValueFromIniSection("/config/ultrapaw/theme.ini", "theme", "selection_bg_color"), "#000000");
            
            Color highlightColor1 = RGB888(parseValueFromIniSection("/config/ultrapaw/theme.ini", "theme", "highlight_color_1"), "#2288CC");
            Color highlightColor2 = RGB888(parseValueFromIniSection("/config/ultrapaw/theme.ini", "theme", "highlight_color_2"), "#88FFFF");
            Color highlightColor = {0xf,0xf,0xf,0xf};
            
            Color clickColor = RGB888(parseValueFromIniSection("/config/ultrapaw/theme.ini", "theme", "click_color"), "#F7253E");
        ...
        public:
            ...
            tsl::Color logoColor1 = RGB888(parseValueFromIniSection("/config/ultrapaw/theme.ini", "theme", "logo_color_1"), "#FFFFFF");
            tsl::Color logoColor2 = RGB888(parseValueFromIniSection("/config/ultrapaw/theme.ini", "theme", "logo_color_2"), "#F7253E");
            
            
            std::string backgroundAlphaStr = parseValueFromIniSection("/config/ultrapaw/theme.ini", "theme", "bg_alpha");
            size_t defaultBackgroundAlpha = (!backgroundAlphaStr.empty()) ? std::stoi(backgroundAlphaStr) : 13;
            
            tsl::Color defaultBackgroundColor = RGB888(parseValueFromIniSection("/config/ultrapaw/theme.ini", "theme", "bg_color"), "#000000", defaultBackgroundAlpha);
            
            tsl::Color defaultTextColor = RGB888(parseValueFromIniSection("/config/ultrapaw/theme.ini", "theme", "text_color"));
            tsl::Color clockColor = RGB888(parseValueFromIniSection("/config/ultrapaw/theme.ini", "theme", "clock_color"));
        ...
        public:
            ...
            Color trackBarColor = RGB888(parseValueFromIniSection("/config/ultrapaw/theme.ini", "theme", "trackbar_color"), "#555555");
        ...
        public:
            std::string seperatorAlphaStr = parseValueFromIniSection("/config/ultrapaw/theme.ini", "theme", "seperator_alpha");
            size_t seperatorAlpha = (!seperatorAlphaStr.empty()) ? std::stoi(seperatorAlphaStr) : 7;
            
            tsl::Color seperatorColor = RGB888(parseValueFromIniSection("/config/ultrapaw/theme.ini", "theme", "seperator_color"), "#777777", seperatorAlpha);
            
            tsl::Color defaultTextColor = RGB888(parseValueFromIniSection("/config/ultrapaw/theme.ini", "theme", "text_color")); ; // CUSTOM MODIFICATION
        ...
        public:
            Color defaultTextColor = RGB888(parseValueFromIniSection("/config/ultrapaw/theme.ini", "theme", "text_color"));
            Color trackBarColor = RGB888(parseValueFromIniSection("/config/ultrapaw/theme.ini", "theme", "trackbar_color"), "#555555");
            std::chrono::duration<long int, std::ratio<1, 1000000000>> t;
            Color highlightColor = {0xf,0xf,0xf,0xf};
            //alf progress;
